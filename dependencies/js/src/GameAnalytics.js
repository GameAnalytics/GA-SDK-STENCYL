...
(function (gameanalytics) {
    ...
    var GameAnalytics = /** @class */ (function () {
        function GameAnalytics() {
        }
        ...
        GameAnalytics.addBusinessEvent = function (currency, amount, itemType, itemId, cartType /*, fields:{[id:string]: any} = {}*/) {
        ...
        GameAnalytics.addResourceEvent = function (flowType, currency, amount, itemType, itemId /*, fields:{[id:string]: any} = {}*/) {
            if (flowType === void 0) { flowType = EGAResourceFlowType.Undefined; }
            if (currency === void 0) { currency = ""; }
            if (amount === void 0) { amount = 0; }
            if (itemType === void 0) { itemType = ""; }
            if (itemId === void 0) { itemId = ""; }
        ...
        GameAnalytics.addProgressionEvent = function (progressionStatus, progression01, progression02, progression03, score /*, fields:{[id:string]: any} = {}*/) {
            if (progressionStatus === void 0) { progressionStatus = EGAProgressionStatus.Undefined; }
        ...
        GameAnalytics.addDesignEvent = function (eventId, value /*, fields:{[id:string]: any} = {}*/) {
            GADevice.updateConnectionType();
            GAThreading.performTaskOnGAThread(function () {
        ...
        GameAnalytics.addErrorEvent = function (severity, message /*, fields:{[id:string]: any} = {}*/) {
            if (severity === void 0) { severity = EGAErrorSeverity.Undefined; }
        ...
        GameAnalytics.setGender = function (gender) {
            if (gender === void 0) { gender = EGAGender.Undefined; }
            GAThreading.performTaskOnGAThread(function () {
